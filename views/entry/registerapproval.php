...
<div class="Entry">
	...
	<fieldset>
		<div class="control-group">
			<?php
				echo $this->Form->Label('Why do you want to join?', 'DiscoveryText', array('class' => 'control-label'));
				echo '<div class="controls">';
	...
	<div class="form-actions">
		<?php echo $this->Form->Button('Apply for Membership', array('class' => 'btn btn-info')); ?>
	</div>
