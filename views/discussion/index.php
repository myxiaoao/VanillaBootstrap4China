...
if ($this->Discussion->Closed == '1') {
	...
	<div class="Foot Closed">
		<div class="Note Closed label label-important"><?php echo T('This discussion has been closed'); ?></div>
	...
	<div class="Foot">
		<?php
		echo Anchor(T('Add a Comment'), SignInUrl($this->SelfUrl.(strpos($this->SelfUrl, '?') ? '&' : '?').'post#Form_Body'), 'TabLink');
		?> 
	</div>
	<?php 
}?>
